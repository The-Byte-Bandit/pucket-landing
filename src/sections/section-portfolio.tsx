...
export default function SectionPortfolio() {
    ...
    return (
        <section id="portfolio" className="max-w-screen-2xl mx-auto pt-20 md:pt-40 flex flex-col-reverse lg:flex-row md:gap-10 items-center px-4 md:px-8">
            {/* Left floating cards */}
            <motion.div className="relative flex mx-auto w-full max-w-2xl mt-10 lg:mt-0" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={staggerContainer}>
                ...
                <div className="relative flex flex-wrap justify-center gap-4 xl:gap-10">
                    <div className="flex flex-col gap-8 items-end mt-16">
                        <motion.div variants={fadeUp} className="flex flex-col justify-center items-center py-10 w-56 rounded-xl border-2 border-white/10 bg-white/[0.05] backdrop-blur-xl p-5 text-white shadow-2xl duration-300 hover:scale-105 active:scale-95">
                        ...
                        <motion.div variants={fadeUp} className="flex items-center justify-center w-32 h-24 rounded-xl border-2 border-white/10 bg-[#E6007A]/20 backdrop-blur-xl p-5 text-white shadow-2xl duration-300 hover:scale-105 active:scale-95">
                            <SiPolkadot className="w-12 h-12 text-[#E6007A]" />
                        </motion.div>
                    </div>
                    <div className="relative flex flex-col gap-10 items-start">
                        <motion.div variants={fadeUp} className="flex items-center justify-center w-32 h-24 rounded-xl border-2 border-[#e9c22e]/10 bg-[#e9c22e]/[0.05] backdrop-blur-xl p-5 text-white shadow-2xl duration-300 hover:scale-105 active:scale-95">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={staggerContainer}>
                ...
                <motion.h2 variants={fadeUp} className="mt-3 text-3xl sm:text-4xl text-white">Create your cryptocurrency<br />portfolio today</motion.h2>
                <motion.p variants={fadeUp} className="mt-4 text-gray-400 max-w-xl">Coinbase has a variety of features that make it the best place to start trading.</motion.p>
                <ul className="mt-8 space-y-6">
                    {bullets.map(({ Icon, text }) => (
                        <motion.li key={text} variants={fadeIn} className="flex items-center gap-3">
